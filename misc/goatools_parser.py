...
# available at https://github.com/tanghaibao/goatools/blob/master/LICENSE
...
class OBOReader(object):
    ...
    def _add_to_ref(self, rec_curr, line, lnum):
        ...
        if mtch:
            ...
            if field_name == "id":
                ...
                if field_value.startswith("UMLS"):

                    rec_curr.umls.append(field_value.split(":")[1])
    ...
    def _init_optional_attrs(self, optional_attrs):
        ...
        self.attrs_req = ['id', 'alt_id', 'name', 'namespace', 'is_a', 'is_obsolete', 'xref']
